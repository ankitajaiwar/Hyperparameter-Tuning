# -*- coding: utf-8 -*-
"""
Created on Tue Oct 23 17:44:03 2018
...
#batch_size = 10
epochs = 30
reg = [None, regularizers.l1(0.0001)]
...
for i in range(0, len(reg)):
    ...
    c = next(color)
    plt.plot(history_val_acc[i], label = "Test Accuracy_Regularizer"+str(1), color = c)
